...
const FILE_PATH = process.env.FILE_PATH || './like'; // 运行文件夹，节点文件存放目录
...
const ZHAZHA_SERVER = process.env.ZHAZHA_SERVER || '';      // 哪吒3个变量不全不运行
const ZHAZHA_PORT = process.env.ZHAZHA_PORT || '';              // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
...
const ARGO_PORT = process.env.ARGO_PORT || 65242;           // Argo端口，使用固定隧道token需和cf后台设置的端口对应
const PORT = process.env.SERVER_PORT || process.env.PORT || 34482; // 节点订阅端口，若无法订阅请手动改为分配的端口
